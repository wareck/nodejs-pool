...
function Coin(data){
    ...
    this.cryptoNight = function(convertedBlob) {
        // Monero seems committed to adjusting POW variants every scheduled 6 month hard fork, but this may not be true
        // for AEON.  Next time AEON hard forks, this *needs* to be reviewed or it could break things.
        let cn_variant = convertedBlob[0] >= 7 ? convertedBlob[0] - 6 : 0;
        // AEON's cn_slow_hash allows for Light or Standard Cryptonight, the "1" here signifies to use the "Light" algorithm
        return cnHashing.cryptonight_light(convertedBlob, 1, cn_variant);
    };
